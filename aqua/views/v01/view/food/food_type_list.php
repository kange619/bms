                            ...
                            <form class="form-horizontal group-border-dashed clearfix" name="fsearch" id="fsearch" method="get" action="">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="sch_keyword" value="<?=$sch_keyword;?>" placeholder="분류명">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <table class="table table-bordered text-center" >
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th class="info" style="width: 60%;" >분류명</th>                                        
                                ...
                                ?>
                                    <form id="list_<?=$value['food_code'];?>" method="post" action="./food_large_cate_proc" >
                                        <input type="hidden" name="mode" id="mode_<?=$value['food_code'];?>" value="edit" >
                                        <input type="hidden" name="page" value="<?=$page?>">
                                        <input type="hidden" name="list_rows" value="<?=$list_rows?>">                                                        
                                        <input type="hidden" name="top_code" value="<?=$top_code?>">
                                        <input type="hidden" name="left_code" value="<?=$left_code?>">
                                        <input type="hidden" name="params" value="<?=$params?>">
                                        <input type="hidden" name="edit_code" value="<?=$value['food_code'];?>">
                                        
                                    <tr>
                                        <td><?=$value['food_code'];?></td>
                                        <td><input type="text" class="form-control" name="title" id="title_<?=$value['food_code'];?>" value="<?=$value['title'];?>" ></td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary" onclick="editCode('list_<?=$value['food_code'];?>')">수정</button>                                            
                                            <button type="button" class="btn btn-info" onclick="location.href='./food_type_set?group_code=<?=$value['group_code'];?>&page=<?=$page.$params?>' ">세부설정</button>
                                            <!-- <button type="button" class="btn btn-danger" onclick="delCode('list_<?=$value['food_code'];?>')" >삭제</button> -->
                                        </td>
                                    </tr>
                                    </form>
                                <?php   
        ...
        <div class="modal-content p-0 b-0">                                    
            <div class="panel panel-color panel-inverse m-0">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">분류 추가</h3>
                </div>
                <div class="panel-body">
                    <div class="row img-contents">
                        <div class="col-lg-12 table-responsive m-b-0">
                            <form name="add_form" id="add_form" method="post" action="./food_large_cate_proc" >
                            ...
                            <table class="table table-bordered text-left">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="info text-center wper20">분류명</td>
                                        <td class="wper80">
