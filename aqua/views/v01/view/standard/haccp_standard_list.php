                        ...
                        <div class="col-lg-12 table-responsive m-b-0">
                            ...
                            <table class="table table-bordered text-left">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="info text-center">등록일(반영일)</td>
                                        <td class="">
                                            <input class="form-control" id="df_apply_date" name="df_apply_date" placeholder="yyyy-mm-dd">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="info text-center">제/개정 내용</td>
                                        <td class="">
                                            <textarea class="form-control" name="df_contents" id="df_contents" cols="30" rows="5"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="info text-center">제/개정 사유</td>
                                        <td class="">
                                            <textarea class="form-control" name="df_reason" id="df_reason" cols="30" rows="5"></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    function documentWrite( arg_type, arg_element ){
        ...
        switch( arg_type ) {
            ...
            case 'edit' : {
                ...
                $('#df_apply_date').val(data.df_apply_date);
                $('#df_contents').val(data.df_contents);
                $('#df_reason').val(data.df_reason);
