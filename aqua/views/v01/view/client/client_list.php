    ...
    <div class="content">
        <div class="container">
                            ...
                            <table class="table table-bordered text-center dataTable" id="excelTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="underline" href="./<?=$page_name?>_write?mode=edit&page=<?=$page?><?=$params?>&client_idx=<?=$value['client_idx'];?>">
                                                <?=$value['company_name'];?>
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger" onclick="delProc('<?=$value['client_idx'];?>')">삭제</button>
                                        </td>
                                    </tr>
                                    <?php   
                                        }
            ...
            <form name="list_form" id="list_form" method="post" action="./<?=$page_name?>_proc">
                ...
                <input type="hidden" name="client_idx" id="client_idx" />
                <input type="hidden" name="page" value="<?=$page?>" />
                <input type="hidden" name="top_code" value="<?=$top_code?>" />
                <input type="hidden" name="left_code" value="<?=$left_code?>" />
