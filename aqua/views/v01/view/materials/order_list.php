...
<!--                                <div class="col-sm-4">-->
<!--                                    <div class="form-group">-->
<!--                                        <label class="col-sm-3 control-label">주문일</label>-->
<!--                                        <div class="col-sm-9">-->
<!--                                            <div class="input-daterange input-group" id="date-range">-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <select class="form-control" name="searchType" id="searchType" >
                                                ...
                                                <option value="order" <?=($searchType == 'order' ? 'selected="selected"' : '' )?> >주문</option>
                                                <option value="receipt" <?=($searchType == 'receipt' ? 'selected="selected"' : '' )?> >입고</option>
                                                <option value="cancel" <?=($searchType == 'cancel' ? 'selected="selected"' : '' )?> >취소</option>
                                            </select>
                            ...
                            <table class="table table-bordered text-center dataTable" id="excelTable">
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th class="info sorting" data-order="receipt_date" >입고예정일</th>
                                        <th class="info sorting" data-order="material_name"  style="width: 10%;">자재명</th> 
                                        <th class="info sorting" data-order="quantity" >주문수량</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>                                                                                  
                                            <button type="button" class="btn btn-sm btn-default waves-effect waves-light" onclick="alert('입고처리되어 변경이 불가합니다.')" >변경불가</button>
                                            <?php
                                                } else {
                                            ?>
                                                <?php
                                        ...
                                        <td>
                                            <?php
                                                if( $value['process_state'] == 'O') {
                                            ?> 
                                            <button type="button" class="btn btn-danger" onclick="delProc('<?=$value['order_idx'];?>')">주문삭제</button>
                                            <?php
                                                } else {
                                            ?>
