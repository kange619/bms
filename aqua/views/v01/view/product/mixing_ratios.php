    ...
    <div class="content">
        <div class="container">
            ...
            <section class="content-header">                    
                <h1>
                    배합비율 정보관리
                    <button type="button" class="pull-right btn btn-primary waves-effect w-md" onclick="location.href='./<?=$page_name?>_edit?page=<?=$page?><?=$params?>'">+등록</button>                    
                </h1>                   
            </section>
                            ...
                            <form class="form-horizontal group-border-dashed clearfix" name="fsearch" id="fsearch" method="get" action="">
                                ...
                                <div class="col-sm-2">
                                        <select class="form-control" name="itemGroup" id="itemGroup" >                                        
                                            <option value="itemGroup1">전체</option>
                                            <option value="itemGroup2">타르트</option>
                                            <option value="itemGroup3">냉동김밥</option>                                        
                                            <option value="itemGroup4">치즈스틱</option>
                                        </select>
                                </div>         

                                <div class="col-sm-2">
                                    <select class="form-control" name="filterRange" id="filterRange" >                                        
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-inverse waves-effect m-l-5" type="button">검색</button>
                                        </span>
                                    </div>
                                </div>                       
