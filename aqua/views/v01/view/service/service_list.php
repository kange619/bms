                            ...
                            <form class="form-horizontal group-border-dashed clearfix" name="fsearch" id="fsearch" method="get" action="">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="sch_keyword" value="<?=$sch_keyword;?>" placeholder="코드, 서비스명">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <table class="table table-bordered text-center" >
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th class="info" style="width: 20%;" >서비스</th>
                                        <th class="info" style="width: 40%;" >설명</th>
                                ...
                                ?>
                                    <form id="list_<?=$value['service_code'];?>" method="post" action="./service_proc" >
                                        <input type="hidden" name="mode" id="mode_<?=$value['service_code'];?>" value="edit" >
                                        <input type="hidden" name="page" value="<?=$page?>">
                                        <input type="hidden" name="list_rows" value="<?=$list_rows?>">                                                        
                                        <input type="hidden" name="top_code" value="<?=$top_code?>">
                                        <input type="hidden" name="left_code" value="<?=$left_code?>">
                                        <input type="hidden" name="params" value="<?=$params?>">
                                        <input type="hidden" name="edit_code" value="<?=$value['service_code'];?>">
                                        
                                    <tr>
                                        <td><?=$value['service_code'];?></td>
                                        <td><input type="text" class="form-control" name="service_name" id="service_name_<?=$value['service_code'];?>" value="<?=$value['service_name'];?>" ></td>
                                        <td>
                                            <textarea class="form-control" name="description" id="description_<?=$value['service_code'];?>" style="width:80%" ><?=$value['description'];?></textarea>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary" onclick="editCode('list_<?=$value['service_code'];?>')">수정</button>                                            
                                            <button type="button" class="btn btn-info" onclick="location.href='./service_items?service_code=<?=$value['service_code'];?>&page=<?=$page.$params?>' ">세부설정</button>
                                            <!-- <button type="button" class="btn btn-danger" onclick="delCode('list_<?=$value['service_code'];?>')" >삭제</button> -->
                                        </td>
                                    </tr>
                                    </form>
                                <?php   
        ...
        <div class="modal-content p-0 b-0">                                    
            <div class="panel panel-color panel-inverse m-0">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">서비스 추가</h3>
                </div>
                <div class="panel-body">
                    <div class="row img-contents">
                        <div class="col-lg-12 table-responsive m-b-0">
                            <form name="add_form" id="add_form" method="post" action="./service_proc" >
                            ...
                            <table class="table table-bordered text-left">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="info text-center wper20">서비스명</td>
                                        <td class="wper80">
                                    ...
                                    <tr>
                                        <td class="info text-center wper20">설명</td>
                                        <td class="wper80">
...
function validCheck( arg_add_str ){
    ...
    if( $('#service_name' + arg_add_str ).val() == '' ) {
        alert('서비스명을 입력해주세요');
        $('#service_name').focus();
        return false;
    }
